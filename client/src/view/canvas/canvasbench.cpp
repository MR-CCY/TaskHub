...
void CanvasBench::startCreateNodeMode(NodeType type, const QString& templateId, const QJsonObject& taskTemplate) {
    auto* task = new CreateTask(type, templateId, taskTemplate, this);
    task->setView(view_);
